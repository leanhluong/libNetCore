...
namespace LibNetCore.Application.Tests;
...
public class PipelineTests
{
    ...
    private ISender BuildSender()
    {
        ...
        services.AddLibNetCoreApplication(typeof(PipelineTests).Assembly);
    ...
    public async Task Registration_RefusesAnEmptyAssemblyList()
    {
        ...
        Assert.Throws<ArgumentException>(() => services.AddLibNetCoreApplication());
